...
namespace Masterplan.Tools.Generators
{
    internal class RoomBuilder
    {
        ...
        private static string random_wall()
        {
            ...
            walls.Add("The walls of this area are made of " + random_material() + ", while the ceiling and floor are " +
                      random_material() + ".");
            walls.Add("This area has been hewn out of solid rock.");
            walls.Add("This area has been panelled in dark wood.");

            var index = Session.Random.Next() % walls.Count;
            return walls[index];
        }
        ...
        private static string random_material()
        {
            ...
            var index = Session.Random.Next() % materials.Count;
        ...
        private static string random_finish()
        {
            ...
            var index = Session.Random.Next() % finishes.Count;
        ...
        private static string random_style()
        {
            ...
            var index = Session.Random.Next() % styles.Count;
            return styles[index];
        }
        ...
        private static string random_deco()
        {
            ...
            var index = Session.Random.Next() % deco.Count;
            return deco[index];
        }
        ...
        private static string random_colour()
        {
            ...
            var index = Session.Random.Next() % colours.Count;
        ...
        private static string random_air()
        {
            ...
            var index = Session.Random.Next() % air.Count;
            return air[index];
        }
        ...
        private static string random_smell()
        {
            ...
            var index = Session.Random.Next() % smells.Count;
            return smells[index];
        }
        ...
        private static string random_sound()
        {
            ...
            var index = Session.Random.Next() % sounds.Count;
            return sounds[index];
        }
        ...
        private static string random_activity()
        {
            ...
            var index = Session.Random.Next() % activities.Count;
