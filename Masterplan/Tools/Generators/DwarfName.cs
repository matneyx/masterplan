    ...
    internal class DwarfName
    {
            ...
            for (var n = 0; n != words; ++n)
            {
                ...
                for (var x = 0; x != syllables; ++x)
                {
                    ...
                    if (x != syllables && Session.Random.Next(10) == 0)
                    {
                        ...
                        var index = Session.Random.Next(extras.Count);
                        word += extras[index];
                    }
                }
        ...
        private static string Name(bool male)
        {
            ...
            switch (Session.Random.Next(8))
            {
                ...
                case 5:
                case 6:
                    name = Prefix() + (male ? suffix_male() : suffix_female()) + " " + Prefix() +
                           (male ? suffix_male() : suffix_female());
                    break;
                case 7:
                    name = Prefix() + (male ? suffix_male() : suffix_female()) + " " + Prefix() +
                           (male ? suffix_male() : suffix_female()) + " '" + Thing(true) + "-" + Thing(false) + "'";
                    break;
            }
